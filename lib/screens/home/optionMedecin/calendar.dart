...
class _CalendarState extends State<Calendar> {
  ...
  void _onDaySelected(DateTime day, List events, evt) {
    setState(() {
      _selectedDay = day;
  ...
  void _create(BuildContext context) {
    ...
    var content = TextField(
      ...
      decoration: InputDecoration(
        ...
        labelText: 'nom patient et heure',
      ),
      onChanged: (value) {
        _name = value;
      },
    ...
    var cancelButton = FlatButton(
        ...
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => build(context)));
        });
    //Navigator.push(
    // context, MaterialPageRoute(builder: (context) => build(context)));
    showDialog(
  ...
  void _addEvent(String event) async {
    ...
    await eventDBS.createItem(EventModel(
        id: "consultation", description: event, eventDate: DateTime.now()));
